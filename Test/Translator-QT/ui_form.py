...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        icon = QIcon()
        icon.addFile(u"images/micro.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"images/jp.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboCustomerLang.addItem(icon1, "")
        icon2 = QIcon()
        icon2.addFile(u"images/uk.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboCustomerLang.addItem(icon2, "")
        icon3 = QIcon()
        icon3.addFile(u"images/vn.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
